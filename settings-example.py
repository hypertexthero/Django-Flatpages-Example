...
ADMINS = (
    # ('First Last', 'email@emailaddress.tld'),
)
...
DATABASES = {
    'default': {
        ...
        'NAME': '/path/to/mysite.db',                      # Or path to database file if using sqlite3.
...
MEDIA_ROOT = '/full/path/to/mysite/myproject/media/'
...
TEMPLATE_DIRS = (
    ...
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
	'/path/to/mysite/myproject/templates',
)
